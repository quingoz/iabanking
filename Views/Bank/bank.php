                ...
                <div class="card">
                    ...
                    <div class="card-body px-0">
                        <div class="table-responsive">
                            <table id="bank-list-table" class="table table-striped" role="grid"
