            ...
            
            {
                ...
                "render": function(data, type, row) {
                    ...
                    html += `<div class="flex align-items-center list-user-action" bis_skin_checked="1">
                                 <a class="btn btn-sm btn-icon btn-warning" data-bs-toggle="tooltip" data-bs-placement="top" data-original-title="Edit" href="${base_url}/bank/edit/${data}" aria-label="Edit" data-bs-original-title="Edit">
